...
export const DIFFICULTY_TIERS = {
    early: {
        rarityWeights: { common: 69, uncommon: 20, rare: 5, epic: 5, legendary: 1 },
        speedMultiplier: 1.0,
        spawnInterval: [1.5, 3.0], // seconds between spawns
    },
    mid: {
        rarityWeights: { common: 39, uncommon: 30, rare: 20, epic: 10, legendary: 1 },
        speedMultiplier: 1.3,
        spawnInterval: [1.0, 2.5],
    },
    late: {
        rarityWeights: { common: 20, uncommon: 15, rare: 30, epic: 20, legendary: 10 },
        speedMultiplier: 1.6,
